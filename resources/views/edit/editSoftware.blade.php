      ...
      <h1 class=" w3-xxxlarge w3-text-red"><b>Nuovo artefatto</b></h1>
            ...
            <form action="{{ route('software.update', $software->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div id="inputOS" class="w3-section">
                    ...
                    <input class="w3-input w3-border" value="{{ old('os', $software->os) }}" type="text" name="os" required>
                </div>

                <div id="inputSupp" class="w3-section">
                    <label>Supporto</label>
                    <input class="w3-input w3-border" value="{{ old('supporto', $software->supporto) }}" type="text" name="supporto" required>
                </div>

                <div id="inputNote" class="w3-section">
                    <label>Note</label>
                    <input class="w3-input w3-border" type="text" value="{{ old('note', $software->note) }}" name="note">
                </div>

                <div id="inputURL" class="w3-section">
                    <label>URL</label>
                    <input class="w3-input w3-border" type="text" value="{{ old('url', $software->url) }}" name="url">
                </div>

                <div id="inputTag" class="w3-section">
                    <label>Tag</label>
                    <input class="w3-input w3-border" type="text" value="{{ old('tag', $software->tag) }}" name="tag">
                </div>
