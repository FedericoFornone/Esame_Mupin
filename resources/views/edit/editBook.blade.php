    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
      ...
      <h1 class=" w3-xxxlarge w3-text-red"><b>Nuovo artefatto</b></h1>
            ...
            <form action="{{ route('book.update', $book->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div id="inputAut" class="w3-section">
                    <label>Autori</label>
                    <input class="w3-input w3-border" value="{{ old('autori', $book->autori) }}" type="text" name="autori" required>
                </div>

                <div id="inputCasa" class="w3-section">
                    <label>Casa Editrice</label>
                    <input class="w3-input w3-border" type="text" value="{{ old('casa_editrice', $book->casa_editrice) }}" name="casa_editrice">
                </div>

                <div id="inputPub" class="w3-section">
                ...
                <div id="inputISBN" class="w3-section">
                ...
                <div id="inputURL" class="w3-section">
                    <label>URL</label>
                    <input class="w3-input w3-border" type="text" value="{{ old('url', $book->url) }}" name="url">
                </div>
