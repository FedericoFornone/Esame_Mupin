...
<body class="antialiased">
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
      ...
      <h1 class=" w3-xxxlarge w3-text-red"><b>Nuovo artefatto</b></h1>
            ...
            <form action="{{ route('peripheral.update', $peripheral->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div id="inputType" class="w3-section">
                    <label>Tipologia</label>
                    <input class="w3-input w3-border" value="{{ old('tipologia', $peripheral->tipologia) }}" type="text" name="type" required>
                </div>

                <div id="inputNote" class="w3-section">
                    <label>Note</label>
                    <input class="w3-input w3-border" type="text" value="{{ old('note', $peripheral->note) }}" name="note">
                </div>

                <div id="inputURL" class="w3-section">
                    <label>URL</label>
                    <input class="w3-input w3-border" type="text" value="{{ old('url', $peripheral->url) }}" name="url">
                </div>
